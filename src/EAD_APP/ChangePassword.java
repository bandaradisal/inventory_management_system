...
public class ChangePassword extends JFrame {
    public ChangePassword() {
        ...
        headerPanel.setBackground(UITheme.primaryColor);
        headerPanel.setPreferredSize(new Dimension(getWidth(), 70));
        JLabel headerLabel = new JLabel("Change Password");
        headerLabel.setFont(UITheme.headerFont);
        headerLabel.setForeground(Color.WHITE);
        headerPanel.add(headerLabel);

        // Form
        JPanel formPanel = new JPanel(new GridBagLayout());
        formPanel.setBackground(UITheme.bgSecondary);
        ...
        buttonPanel.setBackground(UITheme.bgSecondary);
