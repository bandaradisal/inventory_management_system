...
public class Home extends javax.swing.JFrame {
    ...
    private void applyTheme() {
        ...
        // Reset panel backgrounds manually
        jPanel1.setBackground(UITheme.bgSecondary);
        UITheme.stylePanel(jPanel1);
        
        // Style all sidebar navigation buttons
        UITheme.styleButton(jButton1);
        jButton1.setBackground(new java.awt.Color(220, 53, 69)); // Sign out styling
        
        UITheme.buildNavPanel(this, jPanel1, true); // horizontal unified navigation
        UITheme.setupFrameIcon(this);         // unified frame icon

        // Enhance titles
        jLabel2.setFont(UITheme.headerFont);
        jLabel3.setFont(UITheme.headerFont);
        jLabel4.setFont(UITheme.headerFont);
        jLabel2.setForeground(UITheme.primaryText);
        jLabel3.setForeground(UITheme.primaryText);
        jLabel4.setForeground(UITheme.primaryText);

        // Swap the outdated Test.JPG image with the user's custom inventory banner
        try {
            java.net.URL imgURL = getClass().getResource("/Image/inventory_banner.png");
            if (imgURL != null) {
                javax.swing.ImageIcon icon = new javax.swing.ImageIcon(imgURL);
                // The label size needs to be roughly calculated or fixed, or scaled dynamically when drawn
                java.awt.Image img = icon.getImage().getScaledInstance(750, 450, java.awt.Image.SCALE_SMOOTH);
