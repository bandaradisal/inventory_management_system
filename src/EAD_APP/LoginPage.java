...
// Features Implemented: User Authentication System
public class LoginPage extends JFrame {
    public LoginPage() {
        ...
        mainPanel.setBackground(UITheme.bgPrimary);

        // -------- Header Section --------
        JPanel headerPanel = new JPanel(); // Panel for header
        headerPanel.setBackground(UITheme.primaryColor); // Set background color
        ...
        headerLabel.setFont(UITheme.headerFont); // Font styling
        ...
        formPanel.setBackground(UITheme.bgSecondary); // Background color
        ...
        buttonPanel.setBackground(UITheme.bgSecondary); // Match background with form
        ...
        centerPanel.setBackground(UITheme.bgSecondary);
