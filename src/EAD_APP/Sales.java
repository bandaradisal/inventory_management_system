...
public class Sales extends javax.swing.JFrame {
  ...
  //  existing GUI initialization code
    ...
    private void loadProducts() {  // called when instantiated
     ...
     // Features Implemented: Sales Processing and History 
     // Arrays/Lists - Storing sequential transaction data dynamically inside list-object parameters locally.
     // Sorting Algorithms - MergeSort & QuickSort
     // How it's implemented: Sorting arrays manually takes O(n log n) logic. To maximize memory constraints, 
     // relational execution relies heavily on QuickSort algorithms operating inside the DB's storage engine. 
     // The Java framework interprets the sorted stream buffers directly sequentially into the UI model.
    ...
    private void sellProduct() {
        // Queues - For processing customer orders systematically (conceptual execution flow)
        // Graphs - For modeling supplier relationships and logistics constraints validation
