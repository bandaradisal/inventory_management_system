...
public class DemandForecastFrame extends javax.swing.JFrame {
    ...
    private void applyTheme() {
        ...
        jLabel1.setFont(UITheme.headerFont);
        jLabel1.setForeground(UITheme.primaryText);
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setBorder(javax.swing.BorderFactory.createEmptyBorder(20, 0, 20, 0));

        // Fix layout stretching by manually moving components
        jPanel1.remove(jButton1);
        jPanel1.remove(refreshBtn);
        jPanel1.remove(jPanel2);
        
        jPanel2.setLayout(new java.awt.BorderLayout(10, 10));
        jPanel2.removeAll();
        jPanel2.add(statusLabel, java.awt.BorderLayout.NORTH);
        jPanel2.add(jScrollPane2, java.awt.BorderLayout.CENTER);
        
        jPanel1.add(jPanel2, java.awt.BorderLayout.CENTER); // allow table to stretch cleanly
        
        javax.swing.JPanel bottomPanel = new javax.swing.JPanel(new java.awt.FlowLayout(java.awt.FlowLayout.RIGHT, 20, 20));
        bottomPanel.setBackground(UITheme.bgSecondary);
        bottomPanel.add(refreshBtn);
        bottomPanel.add(jButton1);
        
        jPanel1.add(bottomPanel, java.awt.BorderLayout.SOUTH);
        
        // Increase frame size to prevent clipping
